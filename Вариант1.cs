       ...
       static int BinarySearch(int[] arr, int number)
        ...
        static void Main(string[] args)
        {
            ...
            string[] menu = { "Формирование нового массива", "Поиск максимального элемента",
                ...
                "Сортировка массива","Бинарный поиск" ,"Конец работы"};
            int choose = 0;
            int[] arr = new int[0];
            bool isNull = true;
            bool isSorted = false; 
                ...
                switch (choose)
                {
                    ...
                    case 2:
                        switch (isNull)
                        {
                            ...
                            case false:
                                Console.Clear();
                                ColoringNumbers((FindMax(arr)), "Максимальный элемент вашего массива равен ");
                                break;
                        }
                        break;
                    case 3:
                    ...
                    case 5:
                        switch (isNull)
                        {
                            ...
                            case false:
                                ...
                                {
                                    ColoringNumbers(FindFirstEven(arr), "Первым четным элементом массива является: ");
                                }
                                break;
                        }
                        break;
                            ...
                            case false:
                                switch (isSorted)
                                {
                                    ...
                                    case true:
                                        Console.Clear();
                                        PrintArray(arr, "Ваш нынешний массив: ");
                                        int choise4 = ReadInt("Введите число, которое вы хотите найти: ");
                                        int indexChoise4 = BinarySearch(arr, choise4) + 1;
                                        switch (indexChoise4)
                                        {
                                            case 0:
                                                ...
                                                break;
                                            default:
                                                ColoringNumbers(indexChoise4, "Номер элемента, который вы хотите найти, равен ");
                                                break;
                                        }
                                        break;
