...
namespace Laba_4
{
    internal class Вариант1
    {
        ...
        static int FindMax(int[] arr)
        {
            ...
            ColoringNumbers(i + 1, "Номер максимального элемента: ");
            return max;
        }
                        ...
                        switch (isNull)
                        {
                            ...
                            case false:
                                switch (isUnit)
                                {
                                    case true:
                                        Console.Clear();
                                        ColoringNumbers(arr[0], "Ваш массив единичной длины, наибольший элемент: ");
                                        break;
                                    case false:
                                        switch (isSorted)
                                        {
                                            case true:
                                                Console.Clear();
                                                ColoringNumbers(arr.Length - 1, "Номер максимального элемента: ");
                                                ColoringNumbers(arr[arr.Length-1], "Максимальный элемент вашего массива: ");
                                                break;
                                            case false:
                                                Console.Clear();
                                                ColoringNumbers((FindMax(arr)), "Максимальный элемент вашего массива: ");
                                                break;
                                        }
                                        break;
                                }
